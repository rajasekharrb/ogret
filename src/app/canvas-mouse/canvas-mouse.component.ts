...
@Component({
  selector: 'app-canvas-mouse',
  templateUrl: './canvas-mouse.component.html',
  styleUrls: ['./canvas-mouse.component.css']
})
export class CanvasMouseComponent implements OnInit {
